...
# Seed Users
User.create(email: "immichaelweiss@gmail.com", password: "iamstrong")
User.create(email: "anthony.edwardsjr@gmail.com", password: "iamstrong")
User.create(email: "ahardy55@gmail.com", password: "iamstrong")
User.create(email: "dykrause@gmail.com", password: "iamstrong")
User.create(email: "alan.florendo@gmail.com", password: "iamstrong")
...
# Seed Exercises
  ...
  Workout.all.each do |workout|
    rand(5..15).times do
      ...
      if exercise_type_chooser <= 8 #weights
        ...
        ex_name = exercise_name[ex_num].split.map(&:capitalize).join(' ')
  ...
  rand(3..10).times do
    Workout.all.each do |workout|
      WorkoutHistory.create(user_id: workout.user.id, workout_id: workout.id)
    end
  end
    ...
    wh.workout.exercises.each do |ex| # for every exercise in the WH
      if ex.exercise == "weights"
        ...
        if chance_did_exact <= 6 # 60% chance they did it perfectly
          ...
          actual_rest_time = (ex.rest_time * (rand(50..200)/100) ).round
      ...
      elsif ex.exercise == "long distance running"
